...
- By default, GPU-enabled Cloud PCs are provisioned to use GPU-accelerated remote frame encoding.  To learn more about different hardware-accelerated graphics encoding profiles and how to manage them on your GPU-enabled Cloud PCs, visit the following Azure Virtual Desktop documentation page: [Enable GPU Acceleration](/azure/virtual-desktop/graphics-enable-gpu-acceleration?tabs=intune).
