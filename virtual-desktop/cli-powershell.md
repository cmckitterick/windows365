...
Both Azure CLI and Azure PowerShell are available to use in the [Azure Cloud Shell](/azure/cloud-shell/overview.md) natively in the Azure portal with no installation, or you can install them locally on your device for Windows, macOS, and Linux.
