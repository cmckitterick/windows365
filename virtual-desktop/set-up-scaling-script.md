...
Now that you have an Azure Automation account, you'll also need to set up a [managed identity](/azure/automation/automation-security-overview.md#managed-identities) if you haven't already. Managed identities will help your runbook access other Microsoft Entra related resources as well as authenticate important automation processes.
